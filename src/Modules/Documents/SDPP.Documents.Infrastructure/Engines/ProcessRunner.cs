...
/// <summary>
/// Shared "run an external CLI tool safely" helper for every engine in this folder (qpdf,
/// poppler-utils, ghostscript, tesseract). Centralized so the stdout/stderr-drain-deadlock bug
/// found in LibreOfficeEngine (redirecting a stream without ever reading it can block the child
/// process forever once its OS pipe buffer fills) can't be reintroduced one engine at a time.
/// </summary>
